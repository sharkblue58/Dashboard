...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على أحرف أبجدية وأرقام ورموز أحرف أحادية البايت فقط.',
    ...
    'boolean' => 'يجب أن يكون حقل :attribute قيمة صحيحة أو خاطئة.',
    ...
    'email' => 'يجب ان يكون البريد الالكتروني صحيح .',
    ...
    'image' => 'ادخال الصورة مطلوب من فضلك',
    ...
    'password' => [
        ...
        'uncompromised' => 'قد ظهرت القيمة المعطاة لـ :attribute في تسريب بيانات. يرجى اختيار :attribute مختلفة.',
    ],
